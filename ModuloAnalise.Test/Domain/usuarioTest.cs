...
namespace Modelo.Analise.Api.Domain.Tests
{
  public class usuarioTests
  {
    ...
    {
      usuario usuario = new usuario { id_usuario = 1, nome = "nome", nivel_de_acesso = "1", email = "email", senha = "senha", celular = "celular", data_nascimento = new System.DateTime(), data_admissao = new System.DateTime(), filial = new filial() };
      ...
      Assert.NotNull(usuario.GetType().GetProperty("senha"));
